  ...
  return (
    <BrowserRouter>
      <LayoutPrincipal isLogged = {isLogged} >
        <Routes>
          <Route exact path="/challengeAlkemy" element={sessionStorage.getItem("token") ? <Home setData={setData} setLoading={setLoading} error = {error} setError={setError} team={team} loading={loading} setTeam={setTeam}/> : <Navigate to="/login"/>}/>
